    ...
    return (
        <form>
            <div className="relative mb-6">
                <input type="email" id="floating_email_outlined" className="block px-2.5 pb-2.5 pt-4 w-full text-[#1a202c] text-sm text-heading bg-transparent rounded-md border border-solid border-[#d1d5db] border-1 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer" placeholder=" " required />
            ...
            <div className="relative mb-6">
                <input type="password" id="floating_passwd_outlined" className="block px-2.5 pb-2.5 pt-4 w-full text-[#1a202c] text-sm text-heading bg-transparent rounded-md border border-solid border-[#d1d5db] border-1 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer" placeholder="*********" required />
            ...
            <SubmitButton buttontext = "Sign In"></SubmitButton>
        </form>
    );
}
...
export function SignUpForm() {
    return (
        <form>
            <div className="relative mb-6">
                <input type="text" id="floating_name_outlined" className="block px-2.5 pb-2.5 pt-4 w-full text-[#1a202c] text-sm text-heading bg-transparent rounded-md border border-solid border-[#d1d5db] border-1 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer" placeholder=" " required />
